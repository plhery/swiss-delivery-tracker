...
const en = {
  ...
  'auth.subtitle': 'Sign in to sync parcels, delivery alerts, and history across your devices.',
...
const de: Messages = {
  ...
  'auth.subtitle': 'Melde dich an, um Pakete, Liefermeldungen und den Verlauf auf deinen Geräten zu synchronisieren.',
...
const fr: Messages = {
  ...
  'auth.subtitle': 'Connectez-vous pour synchroniser vos colis, alertes et historique sur tous vos appareils.',
...
const it: Messages = {
  ...
  'auth.subtitle': 'Accedi per sincronizzare pacchi, avvisi e cronologia su tutti i tuoi dispositivi.',
