...
const nativeMessages = {
  en: {
    ...
    'welcome.subtitle': 'Track deliveries across France and Switzerland on the web and this iPhone.',
  ...
  de: {
    ...
    'welcome.subtitle': 'Verfolge Lieferungen in Frankreich und der Schweiz im Web und auf diesem iPhone.',
  ...
  fr: {
    ...
    'welcome.subtitle': 'Suivez vos livraisons en France et en Suisse, sur le web et sur cet iPhone.',
  ...
  it: {
    ...
    'welcome.subtitle': 'Segui le consegne in Francia e Svizzera sul web e su questo iPhone.',
