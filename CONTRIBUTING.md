# Contributing to Parcel Post

Thanks for helping improve Parcel Post. Keep changes focused, explain the user
problem they solve, and avoid including real shipment data in code, tests,
screenshots, logs, or issues.
