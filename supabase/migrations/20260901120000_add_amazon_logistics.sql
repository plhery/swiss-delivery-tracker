-- Add Amazon Shipping France to package validation and the quota-enforced
-- package-creation RPC. Its anonymous recipient tracker does not require an
-- extra postcode or capability URL.
